...
export default function About() {
  return (
    <div className='max-w-6xl mx-auto p-3 space-y-4'>
        ...
        <p>
            Our website is designed to provide you with a comprehensive database of movies from all around the world, along with
            the latest news, reviews and trailers. Our movie database is constantly updated with new releases, ensuring that you 
            have access to latest and greatest in the world of cinema.
        </p> 
        <p>
